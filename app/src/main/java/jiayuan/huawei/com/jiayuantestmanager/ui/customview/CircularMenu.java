package jiayuan.huawei.com.jiayuantestmanager.ui.customview;
...
/**
 * 环形菜单
 * Created by xuhuawei on 16/2/16.
 */
public class CircularMenu extends ViewGroup {
    ...
    private OnCircleMenuItemClickListener onItemClickListener;
    ...
    public void setAdapter(List<String> arrayList) {
        PanAdapter adapter=new PanAdapter(arrayList);
    ...
    public OnCircleMenuItemClickListener getOnCircleMenuItemClickListener() {
        return onItemClickListener;
    }

    public void setOnCircleMenuItemClickListener(OnCircleMenuItemClickListener onItemClickListener) {
    ...
    public class PanAdapter extends BaseAdapter{
        ...
        public PanAdapter(List<String> arrayList){
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextView textView = (TextView) LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_layout_desktop, null,false);
